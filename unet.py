...
# input and output settings
	def train(self):
		...
		print('Fitting model...')
		model.fit(imgs_train, imgs_mask_train, batch_size=2, epochs=10, verbose=1, sample_weight = w, validation_split=0.2, shuffle=True, callbacks=[model_checkpoint])
